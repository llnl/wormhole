    ...
    state.isOpen &&
      m('div', { class: 'tw:d-modal tw:d-modal-open' }, [
        m('div', { class: 'tw:d-modal-box' }, [
          m('h3', { class: 'tw:text-lg tw:font-bold tw:mb-4' }, 'Create Token'),
          m(
            'form',
            {
              ...
              onsubmit: async (event: SubmitEvent) => {
                ...
                try {
                  ...
                  const createdToken = await tokenRepo.createToken(token);
                  close(state);
            ...
            [
              ...
              m('div', { class: 'tw:d-form-control tw:w-full' }, [
                ...
                m('input', {
                  ...
                  value: state.nbf,
                  oninput: (event: InputEvent) => {
                    state.nbf = (event.currentTarget as HTMLInputElement).value;
                  },
                }),
              ]),
              m('div', { class: 'tw:d-form-control tw:w-full' }, [
                ...
                m('input', {
                  ...
                  value: state.exp,
                  oninput: (event: InputEvent) => {
                    state.exp = (event.currentTarget as HTMLInputElement).value;
                  },
                }),
              ]),
              state.error &&
